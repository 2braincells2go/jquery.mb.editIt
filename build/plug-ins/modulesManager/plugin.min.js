	...
	var c = {
		...
		update: function( b ) {
			...
			a( "[data-group]" ).each( function() {
				var b = this,
					d = a( b ).is( "[data-editable]" ) ? b : a( b ).children( "[data-editable]" ).eq( 0 ),
					e = a( "<div/>" ).addClass( "modulesManager-buttonBar" ).css( {
						opacity: 0
					} ),
					f = a.editIt.util.drawButton( "Add block", "apply", "editIt-icon-plus", null, null, !0 ),
					g = a.editIt.util.drawButton( "Remove block", "red", "editIt-icon-minus", null, null, !0 );
				f.on( "click", function() {
				...
				} ), e.append( f ), a( b ).data( "removable" ) && e.append( g ), a( d ).append( e ), e.on( "mouseenter", function() {
					e.fadeTo( 100, 1 )
